...
const blogData = [
  {
    id: 1,
    title: "New form Fekkai",
    imageUrl:
      "https://static.thcdn.com/images/small/webp/widgets/208-us/39/1116-STDCRE-43990-CM-DS-Q4-Batching-676x556-063539.jpeg",
    desc: "Three soon-to-be faves to smooth, volumize & hold.",
  },
  {
    id: 2,
    title: "Ask the Esthetician",
    imageUrl:
      "https://static.thcdn.com/images/small/webp/widgets/208-us/30/Ask_The_Esthetician_676x556-092905-040630.png",
    desc: "Sign up for personal recommendations on all things beauty from our in-house estheticians.",
  },
  {
    id: 3,
    title: "Serum Superstars",
    imageUrl:
      "https://static.thcdn.com/images/small/webp/widgets/208-us/10/1116-STDCRE-43990-CM-DS-Q4-Batching-676x556-063610-034610.jpg",
    desc: "The most concentrated products in your skin care arsenal for targeted treatment.",
  },
];
...
export function Category() {
  return (
    <Box maxW="full" my={10}>
      ...
      >
        {categoryData.map((el) => (
          <Box key={el.id} alignSelf="center">
        ...
        {blogData.map((el) => (
          <Box key={el.id} alignSelf="center" align={"center"}>
            <Image
              ...
              mt={2}
            />
            <Text fontSize={{base: "14px", md: "16px", lg: "18px"}} mt={2}>
              {el.title}
            </Text>
            <Text
